  ...
  const AlertItem = ({ alert }) => (
    <div className={`bg-gray-900 border ${alert.type === 'warning' ? 'border-yellow-500/50' : 'border-cyan-500/30'} rounded-lg p-3 sm:p-4 mb-3`}>
      <div className="flex items-start gap-2 sm:gap-3">
        <AlertTriangle className={`${alert.type === 'warning' ? 'text-yellow-400' : 'text-cyan-400'} w-4 h-4 sm:w-5 sm:h-5 mt-0.5`} />
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="bg-gradient-to-r from-gray-900 to-black border-b border-cyan-500/30 px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              {sidebarOpen ? <X className="text-gray-400" size={24} /> : <Menu className="text-gray-400" size={24} />}
            </button>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="flex items-center gap-2 bg-green-500/20 px-2 sm:px-4 py-2 rounded-lg border border-green-500/50">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-green-400 font-medium text-xs sm:text-base">EN LIGNE</span>
            </div>
            <button className="p-2 hover:bg-gray-800 rounded-lg transition-colors">
              <Settings className="text-gray-400 w-5 h-5 sm:w-6 sm:h-6" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex relative">
        ...
        <div className={`
          fixed lg:static
          top-0 left-0
          w-64 bg-gray-900 border-r border-cyan-500/30
          min-h-screen p-4
          z-50
